...
public class FilterController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            int price1=Integer.valueOf(prix1);
            int price2=Integer.valueOf(prix2);
            ConnectionBase connection=new ConnectionBase();
            ArrayList<ChooserPrice> prices=ChooserPrice.getByPrice(connection, price1, price2);
            RequestDispatcher dispatch=request.getRequestDispatcher("Recherche.jsp");
            request.setAttribute("meubles",prices);
