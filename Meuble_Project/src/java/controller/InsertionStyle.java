...
public class InsertionStyle extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet InsertionStyle</title>");            
            out.println("</head>");
            out.println("<body>");
            ...
            out.println("<p>"+strs+"</p>");            
            }
            out.println("<h1>Servlet InsertionStyle at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(InsertionStyle.class.getName()).log(Level.SEVERE, null, ex);
