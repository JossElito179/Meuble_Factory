...
<br><br><br><br>
        ...
        <script>
            function addMatiere(){
                const child=document.querySelector(".containermot");
                const copie=child.cloneNode(true);
                document.querySelector(".containermot2").appendChild(copie);
            }
        ...
        <div class="row">
            <div class="col-lg-5">
                <div class="d-flex flex-column justify-content-center bg-primary h-50 p-5">
                    <div class="card border-0 mb-2">
                        <img class="card-img-top" src="img/thumb-10.jpg" alt="">
            ...
            <div class="col-lg-6 col-md-6 mb-5 ">
                <div class="container w-75">
                    <h4 class="text-primary mb-4">Creer la formule</h4>
                        <div class="form-group">
                            <div class="tab-content">
                                <div class="tab-content-inner active" data-content="signup">
                                    <form action="InsertionFormule" method="get">
                        ...
                        <option value="<%= stl.getId_style() %>"><%= stl.getNom_Style() %></option>
                            ...
                            <% } %>
                                                    ...
                                                    <div class="containermot">
                                                     <label for="nom">Ajout matiere </label>
                                                    <select name="matiere" id="grandeur" class="form-control">
                                                                                <% for (MatierePremiere mats:mts){%>
                                                        <option value="<%= mats.Id_MatierePremiere %>"><%= mats.nom_matiere %></option>
                            <% } %>
                                                    </select>                                                     
                                    ...
                                    <input type="button" onclick="addMatiere()" class="btn btn-primary btn-block" value="Ajout matiere">
                                </div>
                            </div>
                        </div>
                    </div>
